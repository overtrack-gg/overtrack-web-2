...
seasons = {
    ...
    26: Season(name='Season 26', start=1610042400, end=1715489200, index=26, display=True),
    # 27: Season(name='Season 27', start=1615489200, end=1620327600, index=27, display=True),
}
